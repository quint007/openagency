...
function CookieSettingsTrigger() {
  ...
  return (
    <button
      type="button"
      className="fixed right-4 bottom-20 z-[60] rounded-full border border-[color:color-mix(in_srgb,var(--outline-variant)_55%,transparent)] bg-[color:color-mix(in_srgb,var(--surface-container-highest)_96%,transparent)] px-4 py-2 text-xs font-medium uppercase tracking-[0.14em] text-[var(--on-surface-variant)] shadow-[0_12px_28px_color-mix(in_srgb,var(--brand-primary)_10%,transparent)] backdrop-blur-xl transition-colors hover:border-[color:color-mix(in_srgb,var(--brand-primary)_55%,transparent)] hover:text-[var(--on-surface)] focus-visible:border-[var(--brand-primary)] focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-[color:color-mix(in_srgb,var(--brand-primary)_30%,transparent)]"
