...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  const { rows: existingPages } = await db.execute(sql`
    SELECT to_regclass('public.pages') AS existing
  `)

  if (existingPages[0]?.existing) {
    payload.logger.info({
      msg: 'Skipping bootstrap migration because the pages table already exists.',
    })
  ...
  CREATE TABLE "_lessons_v" (
  	...
  	"version_tts_audio_url" varchar,
  	"version_is_free_preview" boolean DEFAULT false,
  ...
  CREATE TABLE "authors_expertise_tags" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"tag" varchar
  ...
  CREATE TABLE "_authors_v_version_expertise_tags" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"tag" varchar,
  ...
  CREATE TABLE "_authors_v_version_social_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"platform" varchar,
  ...
  ALTER TABLE "blog_posts_rels" ADD CONSTRAINT "blog_posts_rels_authors_fk" FOREIGN KEY ("authors_id") REFERENCES "public"."authors"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_blog_posts_v_rels" ADD CONSTRAINT "_blog_posts_v_rels_authors_fk" FOREIGN KEY ("authors_id") REFERENCES "public"."authors"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "courses_rels" ADD CONSTRAINT "courses_rels_authors_fk" FOREIGN KEY ("authors_id") REFERENCES "public"."authors"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_courses_v_rels" ADD CONSTRAINT "_courses_v_rels_authors_fk" FOREIGN KEY ("authors_id") REFERENCES "public"."authors"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "authors_expertise_tags" ADD CONSTRAINT "authors_expertise_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."authors"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_authors_v_version_expertise_tags" ADD CONSTRAINT "_authors_v_version_expertise_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_authors_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_authors_v_version_social_links" ADD CONSTRAINT "_authors_v_version_social_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_authors_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "blog_posts_rels_authors_id_idx" ON "blog_posts_rels" USING btree ("authors_id");
  ...
  CREATE INDEX "_blog_posts_v_rels_authors_id_idx" ON "_blog_posts_v_rels" USING btree ("authors_id");
  ...
  CREATE INDEX "courses_rels_authors_id_idx" ON "courses_rels" USING btree ("authors_id");
  ...
  CREATE INDEX "_courses_v_rels_authors_id_idx" ON "_courses_v_rels" USING btree ("authors_id");
  ...
  CREATE INDEX "_modules_v_version_version_slug_idx" ON "_modules_v" USING btree ("version_slug");
  ...
  CREATE INDEX "_modules_v_rels_lessons_id_idx" ON "_modules_v_rels" USING btree ("lessons_id");
  ...
  CREATE INDEX "authors_expertise_tags_order_idx" ON "authors_expertise_tags" USING btree ("_order");
  CREATE INDEX "authors_expertise_tags_parent_id_idx" ON "authors_expertise_tags" USING btree ("_parent_id");
  ...
  CREATE INDEX "_authors_v_version_expertise_tags_order_idx" ON "_authors_v_version_expertise_tags" USING btree ("_order");
  CREATE INDEX "_authors_v_version_expertise_tags_parent_id_idx" ON "_authors_v_version_expertise_tags" USING btree ("_parent_id");
  CREATE INDEX "_authors_v_version_social_links_order_idx" ON "_authors_v_version_social_links" USING btree ("_order");
  CREATE INDEX "_authors_v_version_social_links_parent_id_idx" ON "_authors_v_version_social_links" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "authors_expertise_tags" CASCADE;
  DROP TABLE "authors_social_links" CASCADE;
  DROP TABLE "authors" CASCADE;
  DROP TABLE "_authors_v_version_expertise_tags" CASCADE;
  DROP TABLE "_authors_v_version_social_links" CASCADE;
